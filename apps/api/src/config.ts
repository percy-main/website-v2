...
const configSchema = z.object({
  ...
  // feature) — MCP is meant for any signed-up member. Non-local values
  // must include ?sslmode=require — Percy Main's RDS rejects non-SSL
  // connections from non-master roles.
  MCP_DB_URL: z.url(),
