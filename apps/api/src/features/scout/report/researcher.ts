...
2. Opposition recent form. ask_play_cricket for the opposition's recent fixtures and player aggregates — e.g. "Find <Opposition>'s last 5 league results in <season>" then "Get player career stats for <names that recurred as top scorers / wicket-takers> on <site_id>". Emit one pc_match record per match's headline output and one pc_aggregate record per player's career stats. Where applicable, emit a dismissal_pattern record summarising how_out frequencies for the player ("5 of his 8 dismissals this season are bowled or LBW").
