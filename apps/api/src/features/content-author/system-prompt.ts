...
- update replaces a block's text with plain text: any bold/italic/links inside that block are lost. Blocks where this matters are marked [has formatting] in the listing - leave them alone unless the user asked for them to change.`;
