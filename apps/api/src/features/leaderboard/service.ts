 ...
 */
export function submitScore(db: Kysely<DB>) {
  return async (userId: string, data: ScoreInput) => {
 ...
 */
export function getLeaderboard(db: Kysely<DB>) {
  return async (game: string, limit: number) => {
