...
type JuniorCricketDocumentDataSlicesSlice = ImageCardsSlice;

/**
 * Content for Junior Cricket documents
 */
interface JuniorCricketDocumentData {
	/**
	 * Slice Zone field in *Junior Cricket*
	 *
	 * - **Field Type**: Slice Zone
	 * - **Placeholder**: *None*
	 * - **API ID Path**: junior_cricket.slices[]
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/field#slices
	 */
	slices: prismic.SliceZone<JuniorCricketDocumentDataSlicesSlice> /**
	 * Meta Title field in *Junior Cricket*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: A title of the page used for social media and search engines
	 * - **API ID Path**: junior_cricket.meta_title
	 * - **Tab**: SEO & Metadata
	...
	/**
	 * Meta Description field in *Junior Cricket*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: A brief summary of the page
	 * - **API ID Path**: junior_cricket.meta_description
	 * - **Tab**: SEO & Metadata
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	...
	/**
	 * Meta Image field in *Junior Cricket*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: junior_cricket.meta_image
	 * - **Tab**: SEO & Metadata
...
/**
 * Junior Cricket document from Prismic
 *
 * - **API ID**: `junior_cricket`
 * - **Repeatable**: `false`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type JuniorCricketDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<
	Simplify<JuniorCricketDocumentData>,
	'junior_cricket',
	Lang
>;
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			JuniorCricketDocument,
			JuniorCricketDocumentData,
			JuniorCricketDocumentDataSlicesSlice,
			NavigationDocument,
